        ...
        <div className="max-w-5xl mx-auto space-y-6">
          <div>
            <h1 className="text-2xl font-bold tracking-tight">
              My <span className="text-orange-500">Added Cars</span>
            </h1>
            <p className="text-xs text-neutral-400 mt-1">
              Manage your active vehicle inventory listings.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {cars.map((car) => (
              <div
                key={car._id}
                className="bg-neutral-900 border border-neutral-800 rounded-xl overflow-hidden p-4 flex flex-col justify-between space-y-4"
              >
