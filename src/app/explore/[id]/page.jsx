  ...
  return (
    <div className="w-full bg-neutral-950 min-h-screen text-white py-12 px-4 md:px-12">
      <div className="max-w-6xl mx-auto space-y-8">
        <Link
          href="/explore"
          className="inline-flex items-center gap-2 text-xs text-neutral-400 hover:text-orange-500 transition-colors uppercase tracking-wider font-semibold"
        >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <Card className="bg-neutral-900 border border-neutral-800 rounded-xl p-5 flex flex-row justify-between items-center">
              <div>
                ...
                <p className="flex items-center text-2xl font-black text-white mt-1">
                  <TbCoinTaka />
                  {car.dailyRentPrice}
              ...
              <div className="text-right">
                ...
                <p className="flex gap-2 text-base font-bold text-neutral-300 mt-1">
                  <GiCarSeat />
            ...
            <div className="space-y-2.5">
              ...
              <p className="text-sm text-neutral-400 leading-relaxed font-light">
                {car.description ||
                  "No custom manufacturer narrative specifications provided for this asset selection package."}
              </p>
            </div>
