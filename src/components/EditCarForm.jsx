...
const EditCarForm = ({ car, id }) => {
  ...
  return (
    <Form
      ...
      className="w-full max-w-xl bg-neutral-900 border border-neutral-800 p-6 rounded-xl shadow-2xl"
    >
      <Fieldset>
        <div className="mb-4">
        ...
        <FieldGroup className="space-y-4">
          ...
          >
            <Label className="text-xs text-neutral-400 font-bold tracking-wider uppercase mb-1 block">
              Rental Price (৳ / Day)
            </Label>
            <Input
              placeholder="3000"
              className="bg-neutral-950 border border-neutral-800 text-sm text-white w-full rounded-md p-2 outline-none"
            />
          ...
          <TextField
            ...
            name="carType"
            type="text"
            defaultValue={car.carType || "Sedan"}
            className="text-white w-full"
          >
            <Label className="text-xs text-neutral-400 font-bold tracking-wider uppercase mb-1 block">
              Vehicle Type
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs text-neutral-400 font-bold tracking-wider uppercase">
              Availability Status
            </label>
            <select
              name="availability"
          ...
          >
            ...
            <TextArea
              ...
              className="bg-neutral-950 border border-neutral-800 text-sm min-h-[90px] text-white w-full rounded-md p-2 outline-none"
            />
            <FieldError className="text-xs text-red-400 mt-1" />
          </TextField>
        </FieldGroup>
        ...
        <Fieldset.Actions className="flex gap-3 justify-end pt-4 border-t border-neutral-800/60 mt-4">
          <button
            ...
            className="text-xs text-neutral-400 hover:text-white px-4 py-2 transition-colors font-semibold"
          >
            Cancel
          </button>
          <Button
            type="submit"
            className="bg-orange-600 hover:bg-orange-700 text-white text-xs px-5 py-2 rounded font-semibold transition-colors flex items-center gap-1.5 h-9"
          >
