      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <div className="text-center max-w-xl mx-auto space-y-2">
          ...
          <p className="text-xs text-neutral-400">
            We engineer rental workflows to provide uncompromised comfort, rapid
            terminal dispatch, and absolute security.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {perks.map((perk, idx) => (
            <div
              key={idx}
              className="bg-neutral-900/40 border border-neutral-900 p-6 rounded-2xl space-y-4 hover:border-neutral-800 transition-colors duration-300"
            >
