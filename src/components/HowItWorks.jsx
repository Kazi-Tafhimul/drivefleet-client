      ...
      <div className="max-w-6xl mx-auto space-y-14">
        <div className="text-center max-w-xl mx-auto space-y-2">
          ...
          <p className="text-xs text-neutral-400">
            Three simple system milestones separating you from your
            high-performance driving deployment.
          </p>
        </div>
        ...
        <div className="text-center pt-4">
          <Link
            href="/explore"
            className="inline-block bg-neutral-900 hover:bg-neutral-850 text-white font-bold text-xs uppercase tracking-widest px-8 py-4 rounded-xl border border-neutral-800 transition-colors shadow-xl"
          >
