        ...
        <Modal.Container placement="auto">
          <Modal.Dialog className="sm:max-w-md bg-neutral-900 border border-neutral-800 text-white rounded-2xl">
            ...
            <Modal.Header>
              ...
              <Modal.Heading className="text-xl font-bold tracking-wide">
                Secure This Asset
              </Modal.Heading>
              <p className="mt-1.5 text-xs text-neutral-400 leading-relaxed">
                Confirm your parameters for the{" "}
                <span className="text-orange-500 font-semibold">{carName}</span>
                . This allocation profile instantly locks your dispatch
                selection.
              </p>
            </Modal.Header>
            ...
            <form onSubmit={handleBookNow}>
              ...
              <Modal.Footer className="border-t border-neutral-800/60 p-4 flex justify-end gap-3">
                <Button
                  slot="close"
                  variant="secondary"
                  className="bg-neutral-800 hover:bg-neutral-700 text-neutral-300 text-xs font-semibold px-4 rounded-lg"
                >
                  Cancel
                </Button>
